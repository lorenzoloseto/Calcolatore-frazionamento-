...
const RIST_INIT = [
  // --- COSTI TECNICI ---
  { nome: "SCIA", gruppo: "costiTecnici", qty: 0, unita: "Corpo", prezzo: 900, prezzoIA: 900, desc: "Segnalazione Certificata di Inizio Attività: pratica per interventi che modificano la distribuzione interna (es. spostamento tramezzi o bagni). Onorario del tecnico per predisposizione e deposito in Comune." },
  ...
  { nome: "Progetto termico", gruppo: "costiTecnici", qty: 0, unita: "Corpo", prezzo: 500, prezzoIA: 500, desc: "Relazione tecnica di legge (L.10/91, D.Lgs 192/2005) e attestato di prestazione energetica (APE) per il nuovo impianto termico." },
  { nome: "Agibilità parziale", gruppo: "costiTecnici", qty: 0, unita: "Corpo", prezzo: 800, prezzoIA: 800, desc: "Attestazione che certifica l'idoneità all'uso di una o più unità già pronte, mentre altre sono ancora in corso di realizzazione: tipica dopo un frazionamento." },
  // --- MURATURE ---
  { nome: "Assistenza muraria", gruppo: "murature", qty: 0, unita: "Corpo", prezzo: 2000, prezzoIA: 2500, desc: "Piccoli lavori edili di supporto agli impiantisti (tracce a muro, ripristini) durante la posa degli impianti elettrico, idraulico e termico." },
  ...
  // --- IMPIANTI ---
  { nome: "Idrico/fognante", gruppo: "impianti", qty: 0, unita: "Corpo", prezzo: 150, prezzoIA: 180, desc: "Realizzazione o rifacimento delle tubazioni di adduzione acqua e scarico fognario dell'unità." },
  { nome: "Impianto elettrico", gruppo: "impianti", qty: 0, unita: "Corpo", prezzo: 3250, prezzoIA: 6500, desc: "Rifacimento completo dell'impianto elettrico (quadro, cablaggi, prese, punti luce) a norma." },
  ...
  { nome: "Canalizzato", gruppo: "impianti", qty: 0, unita: "Corpo", prezzo: 3500, prezzoIA: 5500, desc: "Impianto di climatizzazione con canalizzazioni a soffitto, senza unità interne a vista." },
  { nome: "Scaldabagno elettrico", gruppo: "impianti", qty: 0, unita: "Corpo", prezzo: 350, prezzoIA: 400, desc: "Boiler elettrico per la produzione di acqua calda sanitaria, alternativo alla caldaia." },
  ...
  // --- RIFINITURE ---
  { nome: "Battiscopa", gruppo: "rifiniture", qty: 0, unita: "Ml", prezzo: 17, prezzoIA: 20, desc: "Profilo di finitura alla base delle pareti, fornitura e posa al metro lineare." },
  { nome: "Battiscopa balconi", gruppo: "rifiniture", qty: 0, unita: "Ml", prezzo: 7, prezzoIA: 10, desc: "Battiscopa per esterni/balconi, in materiale resistente alle intemperie." },
  { nome: "Controsoffitto", gruppo: "rifiniture", qty: 0, unita: "Mq", prezzo: 30, prezzoIA: 40, desc: "Controsoffitto in cartongesso per nascondere impianti a vista o uniformare l'altezza dei soffitti." },
  { nome: "Controsoffitto umidi (zone bagno)", gruppo: "rifiniture", qty: 0, unita: "Mq", prezzo: 40, prezzoIA: 60, desc: "Controsoffitto in cartongesso idrorepellente per bagni e zone umide." },
  { nome: "Infissi completi con tapparella e motore", gruppo: "rifiniture", qty: 0, unita: "Mq", prezzo: 550, prezzoIA: 600, desc: "Finestre/porte-finestre complete di tapparella motorizzata, fornitura e posa al mq." },
  ...
  { nome: "Rivestimenti bagno e posa", gruppo: "rifiniture", qty: 0, unita: "Corpo", prezzo: 45, prezzoIA: 50, desc: "Piastrelle a parete per il bagno, fornitura e posa." },
  { nome: "Rubinetteria completa per sanitari e doccia", gruppo: "rifiniture", qty: 0, unita: "Corpo", prezzo: 50, prezzoIA: 350, desc: "Set di rubinetteria per lavabo, doccia e bidet/wc, fornitura e posa." },
  ...
  { nome: "Tinteggiatura interna", gruppo: "rifiniture", qty: 0, unita: "Mq", prezzo: 10, prezzoIA: 10, desc: "Pittura delle pareti interne." },
