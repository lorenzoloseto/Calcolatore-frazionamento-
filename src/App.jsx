...
export default function App() {
  ...
  const exportContrattoAppalto = useCallback(() => {
    ...
    c += `<ul>`;
    c += `<li>Che ${committentiDesc} ovvero “Committente” si impegna ad attribuire specifico incarico di appalto in favore della ${esc(ap.appaltatoreNome)} ovvero “Società Appaltatrice” presso l’immobile sito in ${blank(indirizzoImmobile)};</li>`;
    c += `</ul>`;
    ...
    c += art(1, "Oggetto del contratto", p(`I committenti ${committentiDesc}, in relazione alle qualità sopra specificate, affidano all’impresa “${esc(ap.appaltatoreNome)}” come rappresentata, che accetta, i lavori relativi alla ristrutturazione edilizia della proprietà in oggetto.`)
    ...
    c += art(10, null, p(`Le attività tecniche di progettazione, sicurezza, direzione dei lavori e quant’altro necessario sarà affidata al ${esc(ap.direttoreLavori)} incaricato dalla ${esc(ap.appaltatoreNome)}, manlevando sin d’ora la committente da qualsivoglia onere e/o spesa e/o responsabilità.`));
